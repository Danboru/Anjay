...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), Color.rgb(100,0,0), Color.RED);
        ...
        colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
				...
				public void onAnimationUpdate(ValueAnimator animator) {
					foregroundPolyline.setColor(Color.rgb(255- (int) animator.getAnimatedValue(),0,0));
				}
